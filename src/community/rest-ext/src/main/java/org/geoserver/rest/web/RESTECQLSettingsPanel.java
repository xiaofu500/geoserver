...
public class RESTECQLSettingsPanel extends SettingsPluginPanel {
    ...
    private static Logger LOGGER = Logging.getLogger("org.geoserver.rest.web.RESTECQLSettingsPanel");
    ...
    public RESTECQLSettingsPanel(String id, IModel<SettingsInfo> model) {
        ...
        TextArea ecqlexp = new TextArea(
                "ecqlexp", new MetadataMapModel(metadata, RESTUploadECQLPathMapper.EXPRESSION_KEY, String.class));
